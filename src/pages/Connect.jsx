          ...
          <div className="lg:col-span-7">
            ...
            <Reveal delay={0.05}>
              ...
              >
                ...
                <input name="name" required placeholder="Your Name*" data-testid="connect-name" className="rounded-md border bg-transparent px-4 py-3.5 text-sm outline-none focus:border-[#5CF0CE]" style={{ borderColor: T.border, color: T.text }} />
                <input name="email" type="email" required placeholder="Your Email*" data-testid="connect-email" className="rounded-md border bg-transparent px-4 py-3.5 text-sm outline-none focus:border-[#5CF0CE]" style={{ borderColor: T.border, color: T.text }} />
                <input name="phone" type="tel" placeholder="Your Phone" data-testid="connect-phone" className="rounded-md border bg-transparent px-4 py-3.5 text-sm outline-none focus:border-[#5CF0CE]" style={{ borderColor: T.border, color: T.text }} />
                <input name="organization" required placeholder="Organization*" data-testid="connect-organization" className="rounded-md border bg-transparent px-4 py-3.5 text-sm outline-none focus:border-[#5CF0CE]" style={{ borderColor: T.border, color: T.text }} />
                <textarea name="message" required rows={5} placeholder="Your Message*" data-testid="connect-message" className="rounded-md border bg-transparent px-4 py-3.5 text-sm outline-none focus:border-[#5CF0CE] sm:col-span-2" style={{ borderColor: T.border, color: T.text }} />
