      ...
      <section className="px-6 py-24 md:px-12">
        <div className="mx-auto max-w-[900px]">
          ...
          <Reveal delay={0.05}>
            ...
            >
              <input name="name" required placeholder="Your Name*" data-testid="careers-name" className="rounded-md border bg-transparent px-4 py-3.5 text-sm outline-none focus:border-[#5CF0CE]" style={{ borderColor: T.border, color: T.text }} />
              <input name="phone" type="tel" placeholder="Your Phone" data-testid="careers-phone" className="rounded-md border bg-transparent px-4 py-3.5 text-sm outline-none focus:border-[#5CF0CE]" style={{ borderColor: T.border, color: T.text }} />
              <input name="email" type="email" required placeholder="Your Email*" data-testid="careers-email" className="rounded-md border bg-transparent px-4 py-3.5 text-sm outline-none focus:border-[#5CF0CE]" style={{ borderColor: T.border, color: T.text }} />
              <select name="position" required defaultValue="" data-testid="careers-position" className="rounded-md border bg-transparent px-4 py-3.5 text-sm outline-none focus:border-[#5CF0CE]" style={{ borderColor: T.border, color: T.text }}>
              ...
              <textarea name="message" rows={4} placeholder="Your Message" data-testid="careers-message" className="rounded-md border bg-transparent px-4 py-3.5 text-sm outline-none focus:border-[#5CF0CE] sm:col-span-2" style={{ borderColor: T.border, color: T.text }} />
