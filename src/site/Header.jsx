...
export const Header = () => {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[1400px] items-center justify-between px-6 py-4 md:px-12">
        ...
        <nav className="hidden items-center gap-8 md:flex" data-testid="desktop-nav" aria-label="Primary navigation">
          <div className="relative" onMouseEnter={() => { setSolOpen(true); warmRoute("/solutions"); }} onMouseLeave={() => setSolOpen(false)}>
            ...
            >
              Solutions <ChevronDown size={14} className="transition-transform duration-200" style={{ transform: solOpen ? "rotate(180deg)" : "none" }} />
            </Link>
            {solOpen && (
              <div data-testid="solutions-dropdown" className="absolute left-1/2 top-full w-[420px] -translate-x-1/2 pt-4">
      ...
      {open && (
        <div id="mobile-navigation" data-testid="mobile-menu" className="overflow-hidden border-t md:hidden" style={{ borderColor: T.border, background: T.panel }}>
          <div className="px-6 py-4">
            <button
              ...
              aria-expanded={mSol}
            >
              Solutions <ChevronDown size={16} className="transition-transform duration-200" style={{ transform: mSol ? "rotate(180deg)" : "none" }} />
            </button>
            {mSol && (
